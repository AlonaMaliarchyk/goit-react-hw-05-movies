...
import { getMovieById, getPosterPath } from "../../components/shared/ApiService/ApiService";
...
const MovieDetails = () => {
    ...
    return(
        <>
            ...
            <button onClick={() => navigate(from)} className={css.btn}>Go back</button>
            <div className={css.galleryWrap}>
                <div className={css.wrapImg}>
                    <img className={css.movieDetal} src={getPosterPath(movie?.poster_path)} alt={movie?.title}/>
                </div>
                <div className={css.wrapInform}>
                    <div>
